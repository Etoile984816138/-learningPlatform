      ...
      <mu-row gutter>
        <mu-col width="100" tablet="70" desktop="70">
          ...
          <div class="player-comment" v-show="playerFunctionShow">
            <mu-text-field hintText="多行文本输入，默认 3行，最大6行" multiLine :rows="3" :rowsMax="6" v-model="playerCommentConetnt" fullWidth/>
        ...
        <mu-col width="100" tablet="30" desktop="30">
          <div class="comment-list-wrapper">
            ...
            <div class="send-wrapper">
              <mu-text-field hintText="" multiLine :rows="1" :rowsMax="6" v-model="comment" fullWidth/>
